...
class PoseEstimationWithMobileNet(nn.Module):
    def __init__(self, num_refinement_stages=1, num_channels=128, num_heatmaps=19, num_pafs=38,
        ...
        if self.is_convertible_by_mo:  # 可以被mo.py转换成openvino文件
    ...
    def forward(self, x):
        ...
        if self.is_convertible_by_mo:  # Model Optimizer R3 2019(openvino) cuts out these two network outputs, add fake op to fix it
